...
public class Bomb extends AnimatedEntitiy {
    ...
    protected double _timeToExplode = 120; // thời gian bom nổ
    public int _timeAfter = 20; // thoi gian hiển thị flame
    ...
    protected void explode() {
        _exploded = true;
        sound.gameSound.getIstance().play(sound.gameSound.EXPLOSION);
